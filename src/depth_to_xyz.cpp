...
int main(int argc, char **argv)
{
    ...
    */
    ...
    int rc = stbi_write_png_to_func(stbi_write_to_stdout, NULL, rgb_xyz_image.w, rgb_xyz_image.h, rgb_xyz_image.c, (const void *)zPng, rgb_xyz_image.w * rgb_xyz_image.c);
