...
main(int argc, char **argv)
{
	...
	auto rc = stbi_write_png_to_func([](auto context, auto data,
	                                    auto size) { std::cout.write((const char *)data, size); },
	                                 NULL, xyz_rgb_image.w, xyz_rgb_image.h, xyz_rgb_image.c, (const void *)zPng,
	                                 xyz_rgb_image.w * xyz_rgb_image.c);
